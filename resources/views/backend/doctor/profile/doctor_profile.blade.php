                            ...
                            <div class="profile-head">
                                <div class="photo-content">
                                    ...
                                    <div class="profile-photo">
                                        ...
                                        <img src="{{ asset($doctor->photo) }}" class="img-fluid rounded-circle" alt="" style="width: 150px; height: 150px;">
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-sm-4 border-right-1 prf-col">
                                                    <div class="profile-email">
                                                        <h4 class="text-muted">{{ $doctor->email }}</h4>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-sm-4 prf-col">
                                                    <div class="profile-call">
                                                        <h4 class="text-muted">{{ $doctor->phone }}</h4>
                                                        <p>Phone No.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div id="profile-settings" class="tab-pane fade show active">
                                                <div class="pt-3">
                                                    <div class="settings-form">
                                                        ...
                                                        <form method="POST" action="{{ route('update.doctor.profile') }}" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>Name</label>
                                                                    <input type="name" value="{{ $doctor->name }}" name="name" class="form-control">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label>Phone</label>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label>Role</label>
                                                                <input type="" value="{{ $doctor->role }}" name="role" class="form-control" readonly>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label>Photo</label>
