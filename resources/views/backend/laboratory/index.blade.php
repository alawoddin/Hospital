...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-3"><div class="card p-3"><h6>Tests Today</h6><h3>{{ $today }}</h3></div></div>
        <div class="col-md-3"><div class="card p-3"><h6>Tests This Month</h6><h3>{{ $month }}</h3></div></div>
        <div class="col-md-3"><div class="card p-3"><h6>Tests This Year</h6><h3>{{ $year }}</h3></div></div>
