<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a href="{{ route('admin.dashboard') }}"><span class="nav-text">Dashboard</span></a></li>
            <li><a href="{{ route('all.users') }}"><span class="nav-text">Users</span></a></li>
            ...
            <li><a href="{{ route('all.admin.recieption') }}"><span class="nav-text">Reception Staff</span></a></li>
            <li><a href="{{ route('admin.profile') }}"><span class="nav-text">Profile</span></a></li>
        </ul>
    </div>
</div>
