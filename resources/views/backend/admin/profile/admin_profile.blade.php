    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <!--**********************************
            Header start
        ***********************************-->
        @include('backend.admin.admin_body.admin_header')
        <!--**********************************
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
        @include('backend.admin.admin_body.admin_sidebar')
        <!--**********************************
            Sidebar end
        ***********************************-->
                            ...
                            <div class="profile-head">
                                <div class="photo-content">
                                    ...
                                    <div class="profile-photo">
                                        ...
                                        <img src="{{ asset($admin->photo) }}" class="img-fluid rounded-circle" alt="" style="width: 150px; height: 150px;">
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-sm-4 prf-col">
                                                    <div class="profile-call">
                                                        <h4 class="text-muted">{{ $admin->phone }}</h4>
                                                        <p>Phone No.</p>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <form method="POST" action="{{ route('update.admin.profile') }}" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>Name</label>
                                                                    <input type="name" value="{{ $admin->name }}" name="name" class="form-control">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label>Phone</label>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label>Role</label>
                                                                <input type="" value="{{ $admin->role }}" name="role" class="form-control" readonly>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label>Photo</label>
        ...
        ***********************************-->
        ...
        <!--**********************************
            Footer start
        ***********************************-->
        @include('backend.admin.admin_body.admin_footer')
        <!--**********************************
            Footer end
        ***********************************-->
