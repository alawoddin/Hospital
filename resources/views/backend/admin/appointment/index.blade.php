            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <div>
                            <a href="{{ route('add.admin.appointments') }}" class="btn btn-primary mb-2" style="float:right;">Add Appointment</a>
                        </div>
                            ...
                            <tbody>
                                @foreach($appointments as $key=> $item)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('edit.admin.appointments', $item->id) }}" class="btn btn-info">Edit</a></td>
                                        <td><a href="{{ route('delete.admin.appointments', $item->id) }}" class="btn btn-danger">Delete</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
