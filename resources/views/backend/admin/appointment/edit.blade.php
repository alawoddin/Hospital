...
<div class="container-fluid">
    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('all.admin.appointments') }}">Appointments</a></li>
    ...
    <div class="row">
        <div class="col-xl-12 col-xxl-12 col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('update.admin.appointments') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-xs-12">
                        ...
                        <input type="hidden" name="id" value="{{ $appointments->id }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="patient_id" name="patient_id" required>
                                    ...
                                    @foreach($patients as $patient)
                                        <option value="{{ $patient->id }}" {{ $appointments->patient_id == $patient->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="token_number" name="token_number" value="{{ $appointments->token_number }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="status" name="status">
                                    ...
                                    <option value="canceled" {{ $appointments->status == 'canceled' ? 'selected' : '' }}>Canceled</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description" name="description" cols="5">{{ $appointments->description }}</textarea>
                            </div>

                        </div>
                        <div class="col-xs-12 col-sm-9 col-md-8 mt-3">
                            <button type="submit" class="btn btn-primary">Save</button>
                            <a href="{{ route('all.admin.appointments') }}" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
